...
import com.mxny.ss.datasource.SwitchDataSource;
...
//	@Around("execution(String com.mxny.ec.controller.DeviceController.list(org.springframework.ui.ModelMap, com.mxny.ec.domain.Device))")
...
//	@Pointcut("@annotation(com.mxny.ec.datasource.TargetDataSource)")
//	@Pointcut("@target(com.mxny.ec.datasource.TargetDataSource)")
	public void withinTargetDataSource() {
	}

//	@Before(value = "@annotation(ds)")
//	@Before(value = "@target(com.mxny.ec.datasource.TargetDataSource) || @annotation(com.mxny.ec.datasource.TargetDataSource)")
...
//	@Around("execution(* com.mxny.ec.controller.*.*(..))")
	public Object around(ProceedingJoinPoint point) throws Throwable {
		System.out.println("around:"+point.getTarget());
		Object result = point.proceed();
		return result;
	}
//	@After(value = "@within(com.mxny.ec.datasource.TargetDataSource) && args(ds)", argNames = "point,ds")
