...
import com.mxny.ss.oplog.annotation.LogParam;
import com.mxny.ss.oplog.annotation.OpLog;
import com.mxny.ss.oplog.base.LogContentProvider;
import com.mxny.ss.oplog.base.LogHandler;
import com.mxny.ss.oplog.base.LogInitializer;
...
public class LogAspect {
    ...
    public void init() throws IllegalAccessException, InstantiationException {
        ...
        executor = customThreadPoolExecutorCache.getExecutor("logExecutor");
    }
     ...
     * @throws Throwable
     */
    @Around( "@annotation(com.mxny.ss.oplog.annotation.OpLog)")
