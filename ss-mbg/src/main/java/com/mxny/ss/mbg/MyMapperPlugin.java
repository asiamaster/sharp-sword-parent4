...
public class MyMapperPlugin extends PluginAdapter {
	...
	private void processEntityClass(TopLevelClass topLevelClass, IntrospectedTable introspectedTable) {
		...
		topLevelClass.addImportedType("com.mxny.ss.domain.BaseDomain");
	...
	private void processEntityGetMethodAnnotation(TopLevelClass topLevelClass, IntrospectedTable introspectedTable) {
		topLevelClass.addImportedType("com.mxny.ss.metadata.annotation.FieldDef");
		topLevelClass.addImportedType("com.mxny.ss.metadata.annotation.EditMode");
		topLevelClass.addImportedType("com.mxny.ss.metadata.FieldEditor");
...
//                注释中有JSON参数，则处理成下拉框
	...
	public List<GeneratedJavaFile> contextGenerateAdditionalJavaFiles(
		...
		String dtoSuperInterface = "com.mxny.ss.dto.IBaseDomain";
...
//			}
	...
	private void processDTOGetMethodAnnotation(Interface dtoInterface, IntrospectedTable introspectedTable) {
		...
		dtoInterface.addImportedType(new FullyQualifiedJavaType("com.mxny.ss.metadata.FieldEditor"));
		dtoInterface.addImportedType(new FullyQualifiedJavaType("com.mxny.ss.metadata.annotation.FieldDef"));
		dtoInterface.addImportedType(new FullyQualifiedJavaType("com.mxny.ss.metadata.annotation.EditMode"));
