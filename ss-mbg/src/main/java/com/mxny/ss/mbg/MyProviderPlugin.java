...
//		        preparedStatement.setString(1, "YnProvider");//设置参数从1开始
    ...
    private void generateByJSONObject(JSONObject jsonObject, List<GeneratedJavaFile> mapperJavaFiles) {
	    ...
	    String providerSuperInterface = "com.mxny.ss.metadata.ValueProvider";
    ...
    private void addImport(TopLevelClass clazz){
	    ...
	    clazz.addImportedType(new FullyQualifiedJavaType("com.mxny.ss.metadata.FieldMeta"));
	    clazz.addImportedType(new FullyQualifiedJavaType("com.mxny.ss.metadata.ValuePair"));
	    clazz.addImportedType(new FullyQualifiedJavaType("com.mxny.ss.metadata.ValuePairImpl"));
	    clazz.addImportedType(new FullyQualifiedJavaType("com.mxny.ss.metadata.ValueProvider"));
